...
<body>
    ...
    <div class="container">
        ...
        <!-- Q&A 수정 폼 -->
        <form action="/qna/update/${qna.id}" method="post">
            <!-- 숨겨진 필드로 userId 전달 -->
            <input type="hidden" name="userId" value="${qna.userId}">

            <div class="form-group">
                <label for="writer">작성자명</label>
                <input type="text" class="form-control" id="writer" name="writer" value="${qna.writer}" autocomplete="off" required>
                <div class="form-check mt-2">
                    <input type="checkbox" class="form-check-input" id="useUsername" data-username="${qna.writer}" onclick="toggleWriterName(this)">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" value="${qna.title}" autocomplete="off" required>
            </div>
            
            <div class="form-group">
                <label for="content">내용</label>
                <textarea class="form-control" id="content" name="content" rows="5" autocomplete="off" required>${qna.content}</textarea>
            </div>
